        ...
        <div className="py-16 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-1">
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="text-xl font-bold">AI Discovery</span>
            </div>
          ...
          <div>
            ...
            <a href="mailto:hello@aidiscovery.com" className="flex items-center gap-2 text-slate-400 hover:text-white text-sm transition-colors">
