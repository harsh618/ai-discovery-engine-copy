...
const IndustryCard = ({ industry, isActive }) => {
  ...
  return (
    <motion.div
      ...
      className={`relative bg-white backdrop-blur-xl rounded-2xl border border-slate-200 overflow-hidden transition-all duration-500 shadow-xl ${isActive ? 'ring-2 ring-indigo-500/50' : ''}`}
    >
      {/* Header */}
      <div className="px-4 py-3 border-b border-slate-100 flex items-center gap-2 bg-slate-50">
        ...
        <span className="ml-auto text-[10px] px-2 py-0.5 rounded-full bg-slate-200 text-slate-600">{industry.platform}</span>
      </div>
      ...
      {/* Response */}
      <div className="p-4 bg-gradient-to-b from-white to-indigo-50/50">
        <div className="flex items-start gap-2">
...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen bg-gradient-to-b from-white via-slate-50 to-indigo-50 overflow-hidden">
      {/* Animated Background */}
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <div className="flex items-center gap-8 pt-4">
              <div className="flex -space-x-3">
                {[1,2,3,4,5].map((i) => (
                  <div key={i} className="w-10 h-10 rounded-full bg-gradient-to-br from-indigo-400 to-purple-500 border-2 border-white flex items-center justify-center shadow-md">
          ...
          >
            ...
            <motion.div
              ...
              className="absolute -bottom-4 -left-4 px-3 py-1.5 rounded-lg bg-indigo-100 border border-indigo-200 shadow-lg"
            >
              <span className="text-xs text-indigo-700 font-medium">Live tracking</span>
            </motion.div>
          </motion.div>
        </div>
      </div>
